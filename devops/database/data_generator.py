...
def generate_offers(fake, n, companies):
    offers = []
...
def generate_applications(fake, n, students, offers):
...
def generate_contracts(fake, n, applications, students):
    contracts = []
    ...
    for offer_id in users_applied_to_offer:
        ...
        users_applied_to_offer[offer_id].sort(key=lambda x: students[x]['expedient_grade'], reverse=True)
...
if __name__ == '__main__':
    ...
    offers = generate_offers(fake, 5, companies)
    applications = generate_applications(fake, 5, students, offers)
    contracts = generate_contracts(fake, 5, applications, students)
